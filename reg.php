...
if (isset($_POST['submit'])) {
   ...
   $select = " SELECT * FROM reg WHERE Email = '$email' && Password = '$pass' && user_name = '$u_name' ";
   ...
   if (mysqli_num_rows($result) > 0) {
      ...
      if ($pass != $cpass) {
         ...
         $insert = "INSERT INTO reg(Name, user_name, Email, Contact , Password, role) VALUES('$name','$u_name','$email','$contact','$pass','$user_type')";
